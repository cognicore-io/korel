...
func TestSchemaCreationIdempotent(t *testing.T) {
	...
	expected := 14 // docs, doc_tokens, doc_cats, doc_entities, token_df, token_pairs, cards, stoplist, dict_entries, taxonomy_sectors, taxonomy_events, taxonomy_regions, taxonomy_entities, edges
	if count != expected {
